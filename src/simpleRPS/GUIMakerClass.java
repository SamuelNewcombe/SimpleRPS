	...
	public class GUIListener implements ActionListener {
		...
		public final void winner() throws InterruptedException {
			System.out.println("Your Choice: " + RockPaperSicssors.userChoice + "\nComputer chose: "
					+ RockPaperSicssors.computerChoice);
			RockPaperSicssors.winner = RockPaperSicssors.winner(RockPaperSicssors.computerChoice,
					RockPaperSicssors.userChoice);
